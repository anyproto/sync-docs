...
<figure><img src=".gitbook/assets/ACL (1).png" alt=""><figcaption></figcaption></figure>
...
```protobuf
protobufCopyenum AclUserPermissions {
    None = 0;
...
```protobuf
protobufCopymessage AclContentValue {
  oneof value {
