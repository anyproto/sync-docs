...
description: any-sync's federated infrastructure — node types, local-to-global peer retrieval, and scalable load distribution.
---
...
![any-sync node types and how clients interact with them](../../assets/any-sync-architecture.png)
...
![Two-layer hashing for load distribution across nodes](../../assets/scale.png)
